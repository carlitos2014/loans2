        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">                                        
                    ...
                    <p><strong>Intereses</strong>           $ {{ $credito->valor * $credito->Tasa->name * $credito->Plazo->x }}</p>
                    <p><strong>Saldo Total</strong>         $ {{ $credito->valor * $credito->Tasa->name * $credito->Plazo->x + $credito->valor }}</p>
                    ...
                    <p><strong>Valor Cuota</strong>         $ {{ $credito->valor * $credito->Tasa->name * $credito->Plazo->x + $credito->valor / $credito->formapago_id / $credito->Plazo->num_dias}}</p>
